...
function Paging(paramsObj, callback) {
    ...
    $('#page_ul').on('click','a',function (e) {
        ...
        pageContentInitByPageIndex(that.pageIndex);
...
function  pageContentInitByPageIndex(pageIndex){
    var url = work_space_pagecontent_url+"&startTime="+seachConfig.preInputDate+"&endTime="+seachConfig.preInputDate+"&channelName="+seachConfig.seachWord+"&page="+pageIndex;
    console.log(url);
    pageContentInit(url);
}
...
// 初始化表单数据
function pageContentInit(url){
    treeTableDatas.url = url;
    // $('#demo').bootstrapTreeTable(treeTableDatas);
...
// 表单刷新
function tableFlush(treeTableConfig) {
    $("#demo").bootstrapTreeTable('destroy');
    $('#demo').bootstrapTreeTable(treeTableConfig);
...
test = `[
    {
        ...
        "channelName": "顶级渠道1",
        "channelType": "1",
        "createTime": "2019-09-10 11:17:51",
        "updateTime": "2019-09-10 11:17:51",
        "subChannelShareEntityList": [
            {
                "id": 2,
                "channelLevel": 2,
                "parentId": 1,
                "channelName": "下级渠道1",
                "channelType": "1",
                "createTime": "2019-09-10 11:19:04",
                "updateTime": "2019-09-10 11:19:04",
                "subChannelShareEntityList": null,
                "realNameNum": 3,
                "nonRealNameNum": 4,
                "subChannelRealNameNum": 0,
                "subChannelNonRealNameNum": 0,
                "allShareNum": 7,
                "sort": null
            },
            {
                ...
                "channelName": "下级渠道3",
                "channelType": "1",
                "createTime": "2019-09-10 11:35:13",
                "updateTime": "2019-09-10 11:35:13",
                "subChannelShareEntityList": null,
                "realNameNum": 0,
                "nonRealNameNum": 0,
                "subChannelRealNameNum": 0,
            ...
            },
            {
                ...
                "channelName": "下级渠道2",
                "channelType": "1",
                "createTime": "2019-09-10 11:35:10",
                "updateTime": "2019-09-10 11:35:10",
                "subChannelShareEntityList": null,
                "realNameNum": 0,
                "nonRealNameNum": 0,
                "subChannelRealNameNum": 0,
        ...
        "realNameNum": 1,
        "nonRealNameNum": 1,
        "subChannelRealNameNum": 3,
        "subChannelNonRealNameNum": 4,
        "allShareNum": 9,
        "sort": null
    },
    {
